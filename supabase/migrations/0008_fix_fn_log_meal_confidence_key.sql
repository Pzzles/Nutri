-- BUG: fn_log_meal read item->>'confidence' but CalculatedItem sends
-- the field as 'item_confidence'. meal_items.confidence is NOT NULL so
-- every log-meal call failed with a constraint violation.
